  ...
  return (
    <Router>
      <Flex minHeight="100vh" direction="column">
        <Box as="header" bg="blue.700" color="white" p={4}> 
          <Container maxW="container.xl">
            <Flex alignItems="center" justifyContent="space-between">
              <Heading as="h1" size="lg">Toko Online Alia</Heading>
              <Flex as="nav">
        ...
        <Box as="footer" bg="blue.700" color="white" p={4} mt="auto"> 
          <Container maxW="container.xl" textAlign="center">
            <p>&copy; 2023 Toko Online Alia. Hak Cipta Dilindungi.</p>
          </Container>
        </Box>
      </Flex>
    </Router>
